...
import { Shield, Briefcase, Scale, Globe, Landmark, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16 md:mb-20">
          ...
          <p className="font-sans text-sm sm:text-base text-[#213134]/80 leading-relaxed font-light">
            Wir beraten Unternehmen und Privatpersonen in komplexen nationalen und internationalen Rechtsfragen mit Tiefe, Erfahrung und strategischem Weitblick.
          </p>
        </div>

        {/* 5-Column Cards Layout matching PDF */}
          ...
          {PRACTICE_AREAS.map((area, index) => (
            ...
            >
              <div>
                ...
                <div className="mb-6 inline-flex p-2.5 rounded-sm bg-[#E4D9CC]/30 group-hover:bg-[#C6A15B]/15 transition-colors">
