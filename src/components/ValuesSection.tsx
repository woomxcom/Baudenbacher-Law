...
import { VALUES_TEXT } from '../data/content';
...
export const ValuesSection: React.FC<ValuesSectionProps> = ({ onOpenValuesDetail }) => {
  return (
    <section
      id="values-section"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Right Column: Law Firm Interior / Atmospheric Library & Meeting Space Image */}
          <div className="lg:col-span-6">
            <div className="relative rounded-none overflow-hidden shadow-2xl border border-[#374e52] group">
              {/* High-resolution atmospheric interior matching the warm lamp & dark wood aesthetic in the PDF */}
              <div className="relative aspect-[4/3] sm:aspect-[16/11] w-full overflow-hidden bg-[#182527]">
                <img
                  ...
                  alt="Baudenbacher Law Beratungsräume und Kanzleiarchitektur"
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 bg-[#213134]/90 backdrop-blur-md border border-[#C6A15B]/40 flex items-center justify-between">
                  <div>
                    <div className="font-serif text-sm text-white font-medium">Unabhängige Schweizer & Internationale Kanzlei</div>
                    <div className="text-[11px] font-sans text-[#E4D9CC]/75 mt-0.5">Zürich · Brüssel · Oslo</div>
                  </div>
