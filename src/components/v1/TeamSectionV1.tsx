        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
          {teamMembers.map((member) => (
            ...
            >
              ...
              <div className="relative aspect-[3/4] w-full overflow-hidden bg-[#213134]/10 mb-5 shadow-xs group-hover:shadow-md transition-shadow">
                <img
                  src={member.imageUrl}
                  alt={member.name}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#213134]/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                  <span className="inline-flex items-center gap-1.5 text-xs font-sans text-white font-medium bg-[#213134]/90 px-3 py-1.5 border border-[#C6A15B]/50">
                ...
                {/* Location Pill */}
                <div className="absolute top-3 right-3 bg-[#213134]/85 text-[#E4D9CC] text-[10px] uppercase tracking-wider px-2 py-0.5 font-sans">
                  {member.location}
                </div>
              </div>
