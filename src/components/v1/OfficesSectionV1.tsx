...
interface OfficesSectionV1Props {
  language?: Language;
  onSelectOffice: (city: string) => void;
}

export const OfficesSectionV1: React.FC<OfficesSectionV1Props> = ({
  language = 'de',
  onSelectOffice
}) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {offices.map((office) => (
            <div
              key={office.city}
              id={`v1-office-card-${office.city.toLowerCase()}`}
            ...
            >
              ...
              <div className="relative aspect-[16/9] w-full overflow-hidden bg-[#182527]">
                ...
                <div className="absolute top-3 left-3 bg-[#213134]/90 px-2.5 py-1 text-xs font-serif text-white border border-[#C6A15B]/40">
                  {office.country}
                </div>
              </div>
